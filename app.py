...
with open("workflow_flatvector_api.json" , 'r' , encoding="utf-8") as f:
...
def generate_image(user_input):
    ...
    prompt_text = f"a 2D flat vector art themed drawing of a ({user_input}), simple and clean, colorful, vibrant colors"
    jsonwf["6"]["inputs"]["text"] = prompt_text

    # Set the seed for our KSampler node
    jsonwf["3"]["inputs"]["seed"] = 7377373737
